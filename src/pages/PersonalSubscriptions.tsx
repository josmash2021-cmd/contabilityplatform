...
function getSubIcon(name: string) {
  ...
  if (n.includes("car wash") || n.includes("autowash")) return { icon: Car, bg: "bg-cyan-100", color: "text-cyan-600" };
  if (n.includes("ezpass") || n.includes("sunpass") || n.includes("toll")) return { icon: ParkingCircle, bg: "bg-orange-100", color: "text-orange-600" };
  if (n.includes("planet fit") || n.includes("la fitness") || n.includes("equinox") || n.includes("crunch") || n.includes("ymca") || n.includes("orange theory") || n.includes("soulcycle") || n.includes("peloton") || n.includes("gym")) return { icon: Dumbbell, bg: "bg-emerald-100", color: "text-emerald-600" };
  if (n.includes("adobe") || n.includes("microsoft") || n.includes("office 365") || n.includes("google one") || n.includes("icloud") || n.includes("dropbox") || n.includes("slack") || n.includes("zoom") || n.includes("canva") || n.includes("chatgpt") || n.includes("openai")) return { icon: Cloud, bg: "bg-purple-100", color: "text-purple-600" };
